...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/admin_css/bootstrap-wysihtml5.css')}}">
...
<script src="{{ asset('js/admin_js/wysihtml5-0.3.0.js') }}"></script>
<script src="{{ asset('js/admin_js/bootstrap-wysihtml5.js') }}"></script>
<script>
