<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('images/admin_images/Photography-Llogo_white.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">           
            ...
            <ul class="nav nav-treeview">
             ...
             <!-- Catalogues -->
          @if(Session::get('page')=="event" || Session::get('page')=="album")
              <?php $active="active"; ?>
          @else
              <?php $active=""; ?>
          @endif
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              @if(Session::get('page')=="album")
              <?php $active="active"; ?>
              @else
                  <?php $active=""; ?>
              @endif
              <li class="nav-item">
                <a href="{{ url('admin/albums')}}" class="nav-link {{ $active }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Album</p>
                </a>
              </li>
              ...
              @if(Session::get('page')=="enqurie")
              <?php $active="active"; ?>
              @else
                  <?php $active=""; ?>
              @endif
              <li class="nav-item">
                <a href="{{ url('admin/enquries')}}" class="nav-link {{ $active }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Enquries</p>
                </a>
              </li>   
